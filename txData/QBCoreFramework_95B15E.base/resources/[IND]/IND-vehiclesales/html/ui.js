var app = new Vue({
    ...
    methods: {
        sell(sellPrice) {
            ...
            if (this.sellPrice != "") {
                if (!isNaN(sellPrice)) {
                    ...
                    fetch("https://IND-vehiclesales/sellVehicle", requestOptions);
                    this.close();
                } else {
        ...
        buy() {
            ...
            fetch("https://IND-vehiclesales/buyVehicle", requestOptions);
            this.close();
        },
        takeBack() {
            const requestOptions = {
            ...
            fetch("https://IND-vehiclesales/takeVehicleBack", requestOptions);
            this.close();
        },
        close() {
            const requestOptions = {
            ...
            fetch("https://IND-vehiclesales/close", requestOptions);
