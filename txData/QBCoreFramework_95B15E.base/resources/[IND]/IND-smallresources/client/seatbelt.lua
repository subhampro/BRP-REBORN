...
RegisterNetEvent('INDCore:Client:EnteredVehicle', function()
...
RegisterNetEvent('seatbelt:client:UseHarness', function(ItemData) -- On Item Use (registered server side)
    ...
    if inveh and class ~= 8 and class ~= 13 and class ~= 14 then
        if not harnessOn then
            ...
            INDCore.Functions.Progressbar("harness_equip", Lang:t('seatbelt.use_harness_progress'), 5000, false, true, {
            ...
            LocalPlayer.state:set("inv_busy", true, true)
            INDCore.Functions.Progressbar("harness_equip", Lang:t('seatbelt.remove_harness_progress'), 5000, false, true, {
                disableMovement = false,
                disableCarMovement = false,
                disableMouse = false,
                disableCombat = true,
        ...
        INDCore.Functions.Notify(Lang:t('seatbelt.no_car'), 'error')
    end
end)
