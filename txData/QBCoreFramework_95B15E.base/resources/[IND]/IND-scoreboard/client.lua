...
RegisterNetEvent('IND-scoreboard:client:SetActivityBusy', function(activity, busy)
...
if Config.Toggle then
    RegisterCommand('scoreboard', function()
        if not scoreboardOpen then
            INDCore.Functions.TriggerCallback('IND-scoreboard:server:GetScoreboardData', function(players, cops, playerList)
