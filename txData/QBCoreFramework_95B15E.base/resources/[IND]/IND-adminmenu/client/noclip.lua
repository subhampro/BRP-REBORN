...
ToggleNoClip = function(state)
    ...
    INDCore.Functions.Notify(IsNoClipping and Lang:t("success.noclip_enabled") or Lang:t("success.noclip_disabled"))
...
RegisterNetEvent('IND-admin:client:ToggleNoClip', function()
