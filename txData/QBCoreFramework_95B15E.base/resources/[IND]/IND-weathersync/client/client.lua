...
RegisterNetEvent('INDCore:Client:OnPlayerLoaded', function()
    disable = false
    TriggerServerEvent('IND-weathersync:server:RequestStateSync')
end)

RegisterNetEvent('IND-weathersync:client:EnableSync', function()
    disable = false
    TriggerServerEvent('IND-weathersync:server:RequestStateSync')
end)

RegisterNetEvent('IND-weathersync:client:DisableSync', function()
	disable = true
...
RegisterNetEvent('IND-weathersync:client:SyncWeather', function(NewWeather, newblackout)
    CurrentWeather = NewWeather
    blackout = newblackout
end)

RegisterNetEvent('IND-weathersync:client:SyncTime', function(base, offset, freeze)
    freezeTime = freeze
    timeOffset = offset
    baseTime = base
end)
