...
$(document).on('click', '#save', function(){
    $.post('https://IND-tunerchip/save', JSON.stringify({
...
$(document).on('click', '#reset', function(){
    $.post('https://IND-tunerchip/reset');
});
...
$(document).on('click', "#save-neon", function(){
    if (RainbowNeon) {
        $.post('https://IND-tunerchip/saveNeon', JSON.stringify({
...
$(document).on('click', '#save-headlights', function(){
    $.post('https://IND-tunerchip/saveHeadlights', JSON.stringify({
        value: headlightVal,
...
$(document).on('click', '#save-stancer', function(){
    ...
    $.post('https://IND-tunerchip/SetStancer', JSON.stringify({
...
QBTuner.Open = function() {
    $.post('https://IND-tunerchip/checkItem', JSON.stringify({item: "tunerlaptop"}), function(hasItem){
        if (hasItem) {
