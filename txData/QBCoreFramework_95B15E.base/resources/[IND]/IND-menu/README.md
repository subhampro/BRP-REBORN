# IND-menu
Menu System for the INDCore Framework
...
RegisterCommand("qbmenutest", function(source, args, raw)
    openMenu({
        ...
        },
        {
            ...
            params = {
                event = "IND-menu:client:testMenu2",
                args = {
                    number = 1,
                }
            }
...
```
```
RegisterNetEvent('IND-menu:client:testMenu2', function(data)
    ...
    openMenu({
        ...
        },
        {
            ...
            txt = "Other",
            params = {
                event = "IND-menu:client:testButton",
                args = {
...
```
```
RegisterNetEvent('IND-menu:client:testButton', function(data)
    TriggerEvent('INDCore:Notify', data.message)
end)
```
