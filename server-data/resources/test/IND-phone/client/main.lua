...
RegisterNUICallback('GetCryptoData', function(data, cb)
    INDCore.Functions.TriggerCallback(Config.crypto..'server:GetCryptoData', function(CryptoData)
        cb(CryptoData)
    end, data.crypto)
end)

RegisterNUICallback('BuyCrypto', function(data, cb)
    INDCore.Functions.TriggerCallback(Config.crypto..'server:BuyCrypto', function(CryptoData)
        cb(CryptoData)
    end, data)
end)

RegisterNUICallback('SellCrypto', function(data, cb)
    INDCore.Functions.TriggerCallback(Config.crypto..'server:SellCrypto', function(CryptoData)
        cb(CryptoData)
    end, data)
end)

RegisterNUICallback('TransferCrypto', function(data, cb)
    INDCore.Functions.TriggerCallback(Config.crypto..'server:TransferCrypto', function(CryptoData)
        cb(CryptoData)
    end, data)
end)
...
RegisterNUICallback('GetAvailableRaces', function(_, cb)
    INDCore.Functions.TriggerCallback(Config.lapraces ..'server:GetRaces', function(Races)
        cb(Races)
    end)
end)
...
RegisterNUICallback('GetRaces', function(_, cb)
    INDCore.Functions.TriggerCallback(Config.lapraces ..'server:GetListedRaces', function(Races)
        cb(Races)
    end)
end)

RegisterNUICallback('GetTrackData', function(data, cb)
    INDCore.Functions.TriggerCallback(Config.lapraces ..'server:GetTrackData', function(TrackData, CreatorData)
...
RegisterNUICallback('HasCreatedRace', function(_, cb)
    INDCore.Functions.TriggerCallback(Config.lapraces ..'server:HasCreatedRace', function(HasCreated)
        cb(HasCreated)
    end)
end)
...
RegisterNUICallback('IsAuthorizedToCreateRaces', function(data, cb)
    INDCore.Functions.TriggerCallback(Config.lapraces ..'server:IsAuthorizedToCreateRaces', function(IsAuthorized, NameAvailable)
        data = {
...
RegisterNUICallback('GetRacingLeaderboards', function(_, cb)
    INDCore.Functions.TriggerCallback(Config.lapraces ..'server:GetRacingLeaderboards', function(Races)
        cb(Races)
    end)
end)

RegisterNUICallback('RaceDistanceCheck', function(data, cb)
    INDCore.Functions.TriggerCallback(Config.lapraces ..'server:GetRacingData', function(RaceData)
...
RegisterNUICallback('CanRaceSetup', function(_, cb)
    INDCore.Functions.TriggerCallback(Config.lapraces ..'server:CanRaceSetup', function(CanSetup)
        cb(CanSetup)
    end)
end)
...
RegisterNetEvent('IND-phone:client:TransferMoney', function(amount, newmoney)
    ...
    SendNUIMessage({ action = "PhoneNotification", PhoneNotify = { title = "SBI BANK", text = "&#36;"..amount.." has been added to your account!", icon = "fas fa-university", color = "#8c7ae6", }, })
...
RegisterNUICallback('AcceptPingPlayer', function()
    ...
    TriggerEvent("IND-phone:ping:client:UiUppers", false)
end)
...
RegisterNetEvent(Config.pings ..'client:SendLocation', function(PingData, SenderData)
    INDCore.Functions.Notify('Their location has been blipped on your map', 'success')
    ...
    SetTimeout(5 * (60 * 1000), function()
        INDCore.Functions.Notify('Ping '..PingData.sender..' has expired...', 'error')
...
RegisterNetEvent('IND-phone:ping:client:UiUppers', function(toggle)
    if toggle then
        SendNUIMessage({
