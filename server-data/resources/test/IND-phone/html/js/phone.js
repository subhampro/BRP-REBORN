...
IND.Phone.Functions.SetupRecentCalls = function(recentcalls) {
...
$(document).on('click', '.phone-recent-call', function(e){
    ...
    $.post('https://ef-phone/CallContact', JSON.stringify({
        ContactData: cData,
        Anonymous: IND.Phone.Data.AnonymousCall,
    }), function(status){
        if (cData.number !== IND.Phone.Data.PlayerData.charinfo.phone) {
            if (status.IsOnline) {
                if (status.CanCall) {
                    if (!status.InCall) {
                        if (IND.Phone.Data.AnonymousCall) {
                            IND.Phone.Notifications.Add("fas fa-phone", "Phone", "You started a anonymous call!");
                        }
                        $(".phone-call-outgoing").css({"display":"block"});
                        $(".phone-call-incoming").css({"display":"none"});
                        $(".phone-call-ongoing").css({"display":"none"});
                        $(".phone-call-outgoing-caller").html(cData.name);
                        IND.Phone.Functions.HeaderTextColor("white", 400);
                        IND.Phone.Animations.TopSlideUp('.phone-application-container', 400, -160);
                        setTimeout(function(){
                            $(".phone-app").css({"display":"none"});
                            IND.Phone.Animations.TopSlideDown('.phone-application-container', 400, 0);
                            IND.Phone.Functions.ToggleApp("phone-call", "block");
                        }, 450);

                        CallData.name = cData.name;
                        CallData.number = cData.number;

                        IND.Phone.Data.currentApplication = "phone-call";
                    } else {
                        IND.Phone.Notifications.Add("fas fa-phone", "Phone", "You're already in a call!");
                    }
                } else {
                    IND.Phone.Notifications.Add("fas fa-phone", "Phone", "This person is busy!");
                }
            } else {
                IND.Phone.Notifications.Add("fas fa-phone", "Phone", "This person is not available!");
            }
        } else {
            IND.Phone.Notifications.Add("fas fa-phone", "Phone", "You can't call yourself!");
        }
    });
});
...
IND.Phone.Functions.LoadContacts = function(myContacts) {
...
$(document).on('click', '#new-chat-phone', function(e){
    ...
    if (ContactData.number !== IND.Phone.Data.PlayerData.charinfo.phone) {
        ...
        setTimeout(function(){
            ...
            IND.Phone.Functions.ToggleApp("phone", "none");
            IND.Phone.Functions.ToggleApp("whatsapp", "block");
            IND.Phone.Data.currentApplication = "whatsapp";

            $.post('https://ef-phone/GetWhatsappChat', JSON.stringify({phone: ContactData.number}), function(chat){
                IND.Phone.Functions.SetupChatMessages(chat, {
        ...
        IND.Phone.Notifications.Add("fa fa-phone-alt", "Phone", "You can't whatsapp yourself..", "default", 3500);
    }
});
...
$(document).on('click', '#edit-contact', function(e){
    ...
    IND.Phone.Animations.TopSlideDown(".phone-edit-contact", 200, 0);
});
...
$(document).on('click', '#edit-contact-save', function(e){
    ...
    if (ContactName != "" && ContactNumber != "") {
        $.post('https://ef-phone/EditContact', JSON.stringify({
            ...
            IND.Phone.Functions.LoadContacts(PhoneContacts);
        });
        IND.Phone.Animations.TopSlideUp(".phone-edit-contact", 250, -100);
        setTimeout(function(){
            $(".phone-edit-contact-number").val("");
            $(".phone-edit-contact-name").val("");
        }, 250)
    } else {
        IND.Phone.Notifications.Add("fas fa-exclamation-circle", "Edit Contact", "Fill out all fields!");
    }
});
...
$(document).on('click', '#phone-plus-icon', function(e){
    ...
    IND.Phone.Animations.TopSlideDown(".phone-add-contact", 200, 0);
});
...
$(document).on('click', '#add-contact-save', function(e){
    ...
    if (ContactName != "" && ContactNumber != "") {
        ...
        IND.Phone.Animations.TopSlideUp(".phone-add-contact", 250, -100);
        setTimeout(function(){
        ...
        IND.Phone.Notifications.Add("fas fa-exclamation-circle", "Add Contact", "Fill out all fields!");
    }
});
        ...
        if (cData.number !== IND.Phone.Data.PlayerData.charinfo.phone) {
            if (status.IsOnline) {
                if (status.CanCall) {
                    ...
                    IND.Phone.Notifications.Add("fas fa-phone", "Phone", "This person is in a call!");
                }
            } else {
                IND.Phone.Notifications.Add("fas fa-phone", "Phone", "This person is not available!");
            }
        } else {
            IND.Phone.Notifications.Add("fas fa-phone", "Phone", "You can't call your own number!");
        }
    });
}

CancelOutgoingCall = function() {
    if (IND.Phone.Data.currentApplication == "phone-call") {
        IND.Phone.Animations.TopSlideUp('.phone-application-container', 400, -160);
    ...
    if (!Canceled) {
        if (!IND.Phone.Data.CallActive) {
            ...
            setTimeout(function(){
                ...
                $(".phone-app").css({"display":"none"});
                IND.Phone.Functions.HeaderTextColor("white", 400);
                $("."+IND.Phone.Data.currentApplication+"-app").css({"display":"none"});
            ...
            IND.Phone.Data.currentApplication = "phone-call";
            IND.Phone.Data.CallActive = true;
        }
        setTimeout(function(){
...
IND.Phone.Functions.SetupCurrentCall = function(cData) {
    if (cData.InCall) {
        CallData = cData;
...
$(document).on('click', '.phone-currentcall-container', function(e){
    ...
    IND.Phone.Functions.HeaderTextColor("white", 500);
    IND.Phone.Animations.TopSlideDown('.phone-application-container', 500, 0);
    IND.Phone.Animations.TopSlideDown('.phone-call-app', 500, 0);
    IND.Phone.Functions.ToggleApp("phone-call", "block");
...
IND.Phone.Functions.AnswerCall = function(CallData) {
    $(".phone-call-incoming").css({"display":"none"});
    $(".phone-call-outgoing").css({"display":"none"});
    $(".phone-call-ongoing").css({"display":"block"});
...
IND.Phone.Functions.SetupSuggestedContacts = function(Suggested) {
