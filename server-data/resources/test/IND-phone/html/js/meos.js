...
SetupMeosHome = function() {
    $("#meos-app-name").html("Welcome " + IND.Phone.Data.PlayerData.charinfo.firstname + " " + IND.Phone.Data.PlayerData.charinfo.lastname);
}
...
$(document).on('click', '.person-search-result-apartment > span', function(e){
    ...
    IND.Phone.Notifications.Add("fas fa-university", "MDT", "House number copied!", "#badc58", 1750);
    ...
    if (SearchName !== "") {
        $.post('https://ef-phone/FetchSearchResults', JSON.stringify({
            ...
            if (result != null) {
                ...
                IND.Phone.Notifications.Add("politie", "MDT", "There are no search results!");
                $(".person-search-results").html("");
            }
        });
    } else {
...
$(document).on('click', '.scan-search-vehicle', function(e){
    ...
    $.post('https://ef-phone/FetchVehicleScan', JSON.stringify({}), function(vehicle){
        if (vehicle != null) {
            ...
            IND.Phone.Notifications.Add("politie", "MDT", "No vehicle nearby!");
...
$(document).on('click', '.meos-recent-alert', function(e){
    ...
    if (alertData != undefined){
        if (alertData.coords != undefined && alertData.coords != null) {
            ...
            IND.Phone.Notifications.Add("politie", "MDT", "This alert doesn't have a GPS location!");
        }
    }else {
        IND.Phone.Notifications.Add("politie", "MDT", "There are no alerts available.");
    }
});
...
$(document).on('click', '.meos-clear-alerts', function(e){
    ...
    IND.Phone.Notifications.Add("politie", "MDT", "All alerts have been deleted!");
});
