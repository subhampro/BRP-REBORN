...
$(document).on('click', '.mail', function(e){
    ...
    IND.Phone.Functions.SetupMail(MailData);
...
IND.Phone.Functions.SetupMails = function(Mails) {
    ...
    $("#mail-header-mail").html(IND.Phone.Data.PlayerData.charinfo.firstname+"."+IND.Phone.Data.PlayerData.charinfo.lastname+"@gmail.com");
...
IND.Phone.Functions.SetupMail = function(MailData) {
...
IND.Phone.Functions.RefreshAdverts = function(Adverts) {
    $("#advert-header-name").html("@"+IND.Phone.Data.PlayerData.charinfo.firstname+""+IND.Phone.Data.PlayerData.charinfo.lastname+" | "+IND.Phone.Data.PlayerData.charinfo.phone);
    if (Adverts.length > 0 || Adverts.length == undefined) {
        ...
        $.each(Adverts, function(i, advert){
            ...
            if (advert.number === IND.Phone.Data.PlayerData.charinfo.phone){
...
$(document).on('click','#adv-delete',function(e){
    ...
    $.post('https://ef-phone/DeleteAdvert', function(){
        setTimeout(function(){
            IND.Phone.Notifications.Add("fas fa-ad", "Advertisement", "The ad was deleted", "#ff8f1a", 2000);
        },400)
    });
})
