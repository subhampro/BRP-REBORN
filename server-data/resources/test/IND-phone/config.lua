...
-- Webhooks
Config.serverwebhook = "https://discord.com/api/webhooks/1123356296373084220/esn_Ma0JSqd5NyxCq9e1l_9lHOCCc8zlA8vneJo-ozySdhet6nqExcsoB82uU6eVijr6" ---enter your webhook link here don't forget to do this Important for camera work.
--- Important to add a webhook here


--config here 
Config.corename = 'IND-core' --framework name
Config.target = 'IND-target'
Config.trucker = 'IND-trucker'
Config.crypto = 'IND-crypto'
Config.lapraces = 'IND-lapraces'
Config.houses = 'IND-houses'
Config.pings = 'IND-pings'
Config.hud = "IND-hud"
Config.bossmenu = "IND-bossmenu"
