...
function closeMenu() {
  ...
  $.post('https://IND-hud/closeMenu');
}
function restartHud() {
  closeMenu()
  $.post('https://IND-hud/restartHud');
}
function resetStorage() {
  closeMenu()
  $.post('https://IND-hud/resetStorage');
}
function showOutMap() {
  $.post('https://IND-hud/showOutMap');
}
function showOutCompass() {
  $.post('https://IND-hud/showOutCompass');
}
function showFollowCompass() {
  $.post('https://IND-hud/showFollowCompass');
}
function openMenuSounds() {
  $.post('https://IND-hud/openMenuSounds');
}
function resetHudSounds() {
  $.post('https://IND-hud/resetHudSounds');
}
function checklistSounds() {
  $.post('https://IND-hud/checklistSounds');
}
function showMapNotif() {
  $.post('https://IND-hud/showMapNotif');
}
function showFuelAlert() {
  $.post('https://IND-hud/showFuelAlert');
}
function showCinematicNotif() {
  $.post('https://IND-hud/showCinematicNotif');
}
function dynamicHealth() {
  $.post('https://IND-hud/dynamicHealth');
}
function dynamicArmor() {
  $.post('https://IND-hud/dynamicArmor');
}
function dynamicHunger() {
  $.post('https://IND-hud/dynamicHunger');
}
function dynamicThirst() {
  $.post('https://IND-hud/dynamicThirst');
}
function dynamicStress() {
  $.post('https://IND-hud/dynamicStress');
}
function dynamicOxygen() {
  $.post('https://IND-hud/dynamicOxygen');
}
function dynamicEngine() {
  $.post('https://IND-hud/dynamicEngine');
}
function dynamicNitro() {
  $.post('https://IND-hud/dynamicNitro');
}
function ToggleMapShape() {
  $.post('https://IND-hud/ToggleMapShape');
}
function changeFPS() {
  $.post('https://IND-hud/changeFPS');
}
function ToggleMapBorders() {
  $.post('https://IND-hud/ToggleMapBorders');
}
function HideMap() {
  $.post('https://IND-hud/HideMap');
}
function changeCompassFPS() {
  $.post('https://IND-hud/changeCompassFPS');
}
function showCompassBase() {
  $.post('https://IND-hud/showCompassBase');
}
function showStreetsNames() {
  $.post('https://IND-hud/showStreetsNames');
}
function showPointerIndex() {
  $.post('https://IND-hud/showPointerIndex');
}
function showDegreesNum() {
  $.post('https://IND-hud/showDegreesNum');
}
function cinematicMode() {
  $.post('https://IND-hud/cinematicMode');
}
