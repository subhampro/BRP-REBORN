    ...
    if event == "CEventNetworkEntityDamage" then
        ...
        if victimDied and NetworkGetPlayerIndexFromPed(victim) == PlayerId() and IsEntityDead(PlayerPedId()) then
            ...
            elseif InLaststand and not isDead then
                ...
                local weaponLabel = (INDCore.Shared.Weapons and INDCore.Shared.Weapons[weapon] and INDCore.Shared.Weapons[weapon].label) or 'Unknown'
                local weaponName = (INDCore.Shared.Weapons and INDCore.Shared.Weapons[weapon] and INDCore.Shared.Weapons[weapon].name) or 'Unknown'
                TriggerServerEvent("IND-log:server:CreateLog", "death", Lang:t('logs.death_log_title', {playername = playerName, playerid = GetPlayerServerId(playerid)}), "red", Lang:t('logs.death_log_message', {killername = killerName, playername = playerName, weaponlabel = weaponLabel, weaponname = weaponName}))
