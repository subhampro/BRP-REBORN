...
RegisterNetEvent('IND-radialmenu:ResetClothing', ResetClothing)
...
RegisterNetEvent('IND-radialmenu:ToggleClothing', ToggleClothing)
...
RegisterNetEvent('IND-radialmenu:ToggleProps', ToggleProps)
...
function Notify(message, color) -- However you want your notifications to be shown, you can switch it up here.
	INDCore.Functions.Notify(message, color)
end
