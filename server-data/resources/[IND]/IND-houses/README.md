# IND-houses
Real Estate for IND-Core Framework :house_with_garden:
...
- [IND-radialmenu](https://github.com/qbcore-framework/IND-radialmenu) - For the menu in screenshots
- [IND-anticheat](https://github.com/qbcore-framework/IND-anticheat) - Anti Cheat 
- [IND-phone](https://github.com/qbcore-framework/IND-phone) - Houses app
- [IND-multicharacter](https://github.com/qbcore-framework/IND-multicharacter) - Checking if player is inside after character chosen (You need to edit the lines if you don't use this)
- [IND-garages](https://github.com/qbcore-framework/IND-garages) - House Garage
- [IND-interior](https://github.com/qbcore-framework/IND-interior) - Necessary for house interiors
- [IND-clothing](https://github.com/qbcore-framework/IND-clothing) - Outfits
- [IND-weathersync](https://github.com/qbcore-framework/IND-weathersync) - Desync weather inside house
- [IND-weed](https://github.com/qbcore-framework/IND-weed) - Weed plant
- [IND-skillbar](https://github.com/qbcore-framework/IND-skillbar) - Skills
...
- Import `IND-houses.sql` in your database
- Add the following code to your server.cfg/resouces.cfg
```
ensure IND-core
ensure IND-radialmenu
ensure IND-anticheat
ensure IND-phone
