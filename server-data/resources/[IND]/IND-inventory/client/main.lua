...
local function FormatWeaponAttachments(itemdata)
    ...
    if itemdata.info.attachments ~= nil and next(itemdata.info.attachments) ~= nil then
        for _, v in pairs(itemdata.info.attachments) do
            if exports['IND-weapons']:getConfigWeaponAttachments(itemdata.name) then
                for key, value in pairs(exports['IND-weapons']:getConfigWeaponAttachments(itemdata.name)) do
                    if value.component == v.component then
                        local item = value.item
                        attachments[#attachments+1] = {
                            attachment = key,
                            label = INDCore.Shared.Items[item].label
                            --label = value.label
                        }
                    end
                end
...
local function ItemsToItemInfo()
	local itemInfos = {
		[1] = {costs = INDCore.Shared.Items["metalscrap"]["label"] .. ": 22x, " ..INDCore.Shared.Items["plastic"]["label"] .. ": 32x."},
		[2] = {costs = INDCore.Shared.Items["metalscrap"]["label"] .. ": 30x, " ..INDCore.Shared.Items["plastic"]["label"] .. ": 42x."},
		[3] = {costs = INDCore.Shared.Items["metalscrap"]["label"] .. ": 30x, " ..INDCore.Shared.Items["plastic"]["label"] .. ": 45x, "..INDCore.Shared.Items["aluminum"]["label"] .. ": 28x."},
		[4] = {costs = INDCore.Shared.Items["electronickit"]["label"] .. ": 2x, " ..INDCore.Shared.Items["plastic"]["label"] .. ": 52x, "..INDCore.Shared.Items["steel"]["label"] .. ": 40x."},
		[5] = {costs = INDCore.Shared.Items["metalscrap"]["label"] .. ": 10x, " ..INDCore.Shared.Items["plastic"]["label"] .. ": 50x, "..INDCore.Shared.Items["aluminum"]["label"] .. ": 30x, "..INDCore.Shared.Items["iron"]["label"] .. ": 17x, "..INDCore.Shared.Items["electronickit"]["label"] .. ": 1x."},
		[6] = {costs = INDCore.Shared.Items["metalscrap"]["label"] .. ": 36x, " ..INDCore.Shared.Items["steel"]["label"] .. ": 24x, "..INDCore.Shared.Items["aluminum"]["label"] .. ": 28x."},
		[7] = {costs = INDCore.Shared.Items["metalscrap"]["label"] .. ": 32x, " ..INDCore.Shared.Items["steel"]["label"] .. ": 43x, "..INDCore.Shared.Items["plastic"]["label"] .. ": 61x."},
		[8] = {costs = INDCore.Shared.Items["metalscrap"]["label"] .. ": 50x, " ..INDCore.Shared.Items["steel"]["label"] .. ": 37x, "..INDCore.Shared.Items["copper"]["label"] .. ": 26x."},
		[9] = {costs = INDCore.Shared.Items["iron"]["label"] .. ": 60x, " ..INDCore.Shared.Items["glass"]["label"] .. ": 30x."},
		[10] = {costs = INDCore.Shared.Items["aluminum"]["label"] .. ": 60x, " ..INDCore.Shared.Items["glass"]["label"] .. ": 30x."},
		[11] = {costs = INDCore.Shared.Items["iron"]["label"] .. ": 33x, " ..INDCore.Shared.Items["steel"]["label"] .. ": 44x, "..INDCore.Shared.Items["plastic"]["label"] .. ": 55x, "..INDCore.Shared.Items["aluminum"]["label"] .. ": 22x."},
		[12] = {costs = INDCore.Shared.Items["iron"]["label"] .. ": 50x, " ..INDCore.Shared.Items["steel"]["label"] .. ": 50x, "..INDCore.Shared.Items["screwdriverset"]["label"] .. ": 3x, "..INDCore.Shared.Items["advancedlockpick"]["label"] .. ": 2x."},
	}
...
local function SetupAttachmentItemsInfo()
	local itemInfos = {
		[1] = {costs = INDCore.Shared.Items["metalscrap"]["label"] .. ": 140x, " .. INDCore.Shared.Items["steel"]["label"] .. ": 250x, " .. INDCore.Shared.Items["rubber"]["label"] .. ": 60x"},
		[2] = {costs = INDCore.Shared.Items["metalscrap"]["label"] .. ": 165x, " .. INDCore.Shared.Items["steel"]["label"] .. ": 285x, " .. INDCore.Shared.Items["rubber"]["label"] .. ": 75x"},
		[3] = {costs = INDCore.Shared.Items["metalscrap"]["label"] .. ": 190x, " .. INDCore.Shared.Items["steel"]["label"] .. ": 305x, " .. INDCore.Shared.Items["rubber"]["label"] .. ": 85x, " .. INDCore.Shared.Items["smg_extendedclip"]["label"] .. ": 1x"},
		[4] = {costs = INDCore.Shared.Items["metalscrap"]["label"] .. ": 205x, " .. INDCore.Shared.Items["steel"]["label"] .. ": 340x, " .. INDCore.Shared.Items["rubber"]["label"] .. ": 110x, " .. INDCore.Shared.Items["smg_extendedclip"]["label"] .. ": 2x"},
		[5] = {costs = INDCore.Shared.Items["metalscrap"]["label"] .. ": 230x, " .. INDCore.Shared.Items["steel"]["label"] .. ": 365x, " .. INDCore.Shared.Items["rubber"]["label"] .. ": 130x"},
		[6] = {costs = INDCore.Shared.Items["metalscrap"]["label"] .. ": 255x, " .. INDCore.Shared.Items["steel"]["label"] .. ": 390x, " .. INDCore.Shared.Items["rubber"]["label"] .. ": 145x"},
		[7] = {costs = INDCore.Shared.Items["metalscrap"]["label"] .. ": 270x, " .. INDCore.Shared.Items["steel"]["label"] .. ": 435x, " .. INDCore.Shared.Items["rubber"]["label"] .. ": 155x"},
		[8] = {costs = INDCore.Shared.Items["metalscrap"]["label"] .. ": 300x, " .. INDCore.Shared.Items["steel"]["label"] .. ": 469x, " .. INDCore.Shared.Items["rubber"]["label"] .. ": 170x"},
	}
...
local function CreateItemDrop(index)
	...
	if Config.UseTarget then
		exports['IND-target']:AddTargetEntity(dropItem, {
			options = {
				{
...
RegisterNetEvent('INDCore:Client:OnPlayerLoaded', function()
    ...
    INDCore.Functions.TriggerCallback("inventory:server:GetCurrentDrops", function(theDrops)
		Drops = theDrops
    end)
end)
...
RegisterNetEvent("IND-inventory:client:closeinv", function()
    closeInventory()
end)

RegisterNetEvent('inventory:client:CheckOpenState', function(type, id, label)
    local name = INDCore.Shared.SplitStr(label, "-")[2]
    if type == "stash" then
    ...
    if bool then
        for k in pairs(items) do
            itemTable[#itemTable+1] = {
                item = items[k].name,
                label = INDCore.Shared.Items[items[k].name]["label"],
                image = items[k].image,
            }
        end
    end
...
RegisterNetEvent('inventory:client:CraftItems', function(itemName, itemCosts, amount, toSlot, points)
    ...
    isCrafting = true
    INDCore.Functions.Progressbar("repair_vehicle", Lang:t("progress.crafting"), (math.random(2000, 5000) * amount), false, true, {
	    ...
	    StopAnimTask(ped, "mini@repair", "fixing_a_player", 1.0)
            ...
            TriggerEvent('inventory:client:ItemBox', INDCore.Shared.Items[itemName], 'add')
            isCrafting = false
	end, function() -- Cancel
	    StopAnimTask(ped, "mini@repair", "fixing_a_player", 1.0)
            INDCore.Functions.Notify(Lang:t("notify.failed"), "error")
            isCrafting = false
	end)
end)
...
RegisterNetEvent('inventory:client:PickupSnowballs', function()
    ...
    INDCore.Functions.Progressbar("pickupsnowball", Lang:t("progress.snowballs"), 1500, false, true, {
        disableMovement = true,
        disableCarMovement = true,
        disableMouse = false,
        disableCombat = true,
	...
	TriggerServerEvent('inventory:server:snowball', 'add')
        TriggerEvent('inventory:client:ItemBox', INDCore.Shared.Items["snowball"], "add")
    end, function() -- Cancel
        ClearPedTasks(ped)
        INDCore.Functions.Notify(Lang:t("notify.canceled"), "error")
    end)
end)
...
RegisterNetEvent('IND-inventory:client:giveAnim', function()
    ...
    if not isCrafting and not inInventory then
        if not PlayerData.metadata["isdead"] and not PlayerData.metadata["inlaststand"] and not PlayerData.metadata["ishandcuffed"] and not IsPauseMenuActive() then
            ...
            if IsPedInAnyVehicle(ped, false) then -- Is Player In Vehicle
                ...
                CurrentGlovebox = INDCore.Functions.GetPlate(vehicle)
                curVeh = vehicle
                CurrentVehicle = nil
            else
                local vehicle = INDCore.Functions.GetClosestVehicle()
		    ...
		    local trunkpos = GetOffsetFromEntityInWorldCoords(vehicle, 0.0, (dimensionMin.y), 0.0)
                    ...
                    if #(pos - trunkpos) < 1.5 and not IsPedInAnyVehicle(ped) then
                        if GetVehicleDoorLockStatus(vehicle) < 2 then
                            CurrentVehicle = INDCore.Functions.GetPlate(vehicle)
                            curVeh = vehicle
                            CurrentGlovebox = nil
                        else
                            INDCore.Functions.Notify(Lang:t("notify.vlocked"), "error")
                            return
                        end
                    else
                        CurrentVehicle = nil
...
RegisterNUICallback('Notify', function(data, cb)
    INDCore.Functions.Notify(data.message, data.type)
    cb('ok')
end)

RegisterNUICallback('GetWeaponData', function(cData, cb)
    local data = {
        WeaponData = INDCore.Shared.Items[cData.weapon],
...
RegisterNUICallback('RemoveAttachment', function(data, cb)
    local ped = PlayerPedId()
    local WeaponData = INDCore.Shared.Items[data.WeaponData.name]
    local Attachment = exports['IND-weapons']:getConfigWeaponAttachments(WeaponData.name:upper())[data.AttachmentData.attachment]
    INDCore.Functions.TriggerCallback('weapons:server:RemoveAttachment', function(NewAttachments)
        if NewAttachments ~= false then
            ...
            for _, v in pairs(NewAttachments) do
                for _, pew in pairs(exports['IND-weapons']:getConfigWeaponAttachments(WeaponData.name:upper())) do
...
RegisterNUICallback('getCombineItem', function(data, cb)
    cb(INDCore.Shared.Items[data.item])
end)
...
RegisterNUICallback('combineWithAnim', function(data, cb)
    ...
    INDCore.Functions.Progressbar("combine_anim", animText, animTimeout, false, true, {
...
RegisterNUICallback("GiveItem", function(data, cb)
    local player, distance = INDCore.Functions.GetClosestPlayer(GetEntityCoords(PlayerPedId()))
    if player ~= -1 and distance < 3 then
        if data.inventory == 'player' then
            ...
            INDCore.Functions.Notify(Lang:t("notify.notowned"), "error")
        end
    else
        INDCore.Functions.Notify(Lang:t("notify.nonb"), "error")
    end
    cb('ok')
end)
...
CreateThread(function()
    if Config.UseTarget then
        exports['IND-target']:AddTargetModel(Config.VendingObjects, {
            options = {
                {
...
CreateThread(function()
    if Config.UseTarget then
        exports['IND-target']:AddTargetModel(Config.CraftingObject, {
            options = {
                {
