...
doAction = function(veh)
	...
	INDCore.Functions.TriggerCallback('INDCore:HasItem', function(result)
		if result then
			...
			--exports['progressbar']:startUI(9250, "POSIZIONANDO IL CRIC") -- TRANSLATE THIS, THAT SAY WHEN YOU PUT THE CRIC
			--INDCore.Functions.Notify('Started Repairing', 'Success')
			INDCore.Functions.Notify('POSITIONING THE JACK', 'Success')
			...
			--exports['progressbar']:startUI(11000, "AGGIUSTANDO IL VEICOLO") -- TRANSLATE THIS - THAT SAY WHEN YOU REPAIR THE VEHICLE
			INDCore.Functions.Notify('ADJUSTING THE VEHICLE', 'Success')
			...
			--exports['progressbar']:startUI(8250, "LEVANDO IL CRICK") -- TLANSTALE THIS - THAT SAY WHEN YOU LEAVE THE CRIC
			INDCore.Functions.Notify('LEAVING THE CRICK', 'Success')
			TaskPlayAnimAdvanced(ped, dict, 'car_bomb_mechanic', coords, 0.0, 0.0, headin, 1.0, 0.5, 1250, 1, 0.0, 1, 1)
			Citizen.Wait(1250)
			SetEntityCoordsNoOffset(veh, vehpos.x, vehpos.y, vehpos.z + 0.4, true, true, true)
			TaskPlayAnimAdvanced(ped, dict, 'car_bomb_mechanic', coords, 0.0, 0.0, headin, 1.0, 0.5, 1000, 1, 0.25, 1, 1)
			...
			INDCore.Functions.Notify('You dont have enough Materials. You need repairkit or advancedrepairkit', 'error')
		end
	end, 'repairkit' or 'advancedrepairkit')
end
...
mechanicMenu = function(veh)
	...
	MenuTitle = "Mechanic"
	ClearMenu()
	Menu.addButton("Repair", 'doAction', veh)
...
RegisterNetEvent("IND-repair:client:triggerMenu")
AddEventHandler("IND-repair:client:triggerMenu", function()
