# IND-policejob
Police Job for IND-Core Framework :police_officer:
...
- [IND-bossmenu](https://github.com/qbcore-framework/IND-bossmenu)  (Deprecated) - For the boss menu
- [IND-management](https://github.com/qbcore-framework/IND-management) (Replaces IND-bossmenu) - For the boss/gang menu
- [IND-garages](https://github.com/qbcore-framework/IND-garages) - For the vehicle spawner
- [IND-clothing](https://github.com/qbcore-framework/IND-clothing) - For the locker room
- [IND-phone](https://github.com/qbcore-framework/IND-phone) - For the MEOS app and notifications etc.
- [IND-log](https://github.com/qbcore-framework/IND-logs) - (Deprecated) - For logging certain events
- [IND-smallresources](https://github.com/qbcore-framework/IND-smallresources) (Replaces IND-log) - IND-log was added to IND-smallresources
- [IND-menu](https://github.com/qbcore-framework/IND-menu) - For the vehicle menus
- [IND-input](https://github.com/qbcore-framework/IND-input) - For accessing evidence stashes
